...
export type PageElementType = (typeof PAGE_ELEMENT_TYPES)[keyof typeof PAGE_ELEMENT_TYPES]

export const PAGE_ELEMENT_TYPE_VALUES = Object.values(PAGE_ELEMENT_TYPES)

export const CHART_TYPES = Object.freeze(['bar', 'line', 'pie', 'doughnut'] as const)
...
export const GALLERY_MEDIA_TYPES = Object.freeze(['image', 'video', 'document'] as const)
