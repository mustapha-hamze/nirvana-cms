...
export const SECTION_SPACING_VALUES = Object.freeze(['compact', 'normal', 'spacious'] as const)
export const SECTION_WIDTH_VALUES = Object.freeze(['contained', 'full'] as const)
export const SECTION_TEXT_ALIGN_VALUES = Object.freeze(['left', 'center', 'right'] as const)
