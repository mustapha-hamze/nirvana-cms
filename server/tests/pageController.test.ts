...
function makePageDetailsInstance(fields: any = {}) {
  const instance: any = {
    page: fields.page,
...
const PageDetailsCtor: any = jest.fn((fields: any) => makePageDetailsInstance(fields));
...
function makePageInstance(fields: any = {}) {
  const instance: any = {
